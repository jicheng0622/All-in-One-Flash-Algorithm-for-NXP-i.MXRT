...
enum _flexspi_nor_status
{
    ...
    kStatus_FlexSPINOR_NotSupported = MAKE_STATUS(kStatusGroup_SDK_FLEXSPINOR, 4),    // Status for PageSize overflow
    ...
    kStatus_FLEXSPINOR_Flash_NotFound = MAKE_STATUS(kStatusGroup_SDK_FLEXSPINOR, 9), //!< Status for Flash detection failure
