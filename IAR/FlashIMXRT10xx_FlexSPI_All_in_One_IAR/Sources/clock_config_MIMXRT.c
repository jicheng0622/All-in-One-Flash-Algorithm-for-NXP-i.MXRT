...
// Code
////////////////////////////////////////////////////////////////////////////////
#if defined(MIMXRT1062_SERIES) || defined(MIMXRT1052_SERIES) || defined(MIMXRT1064_SERIES)
void clock_setup(void)
{
...
void clock_setup(void)
{
    ...
    uint32_t SystemCoreClock = ((clock_freq == 0) ? FREQ_396MHz : FREQ_528MHz) / clock_divider;
